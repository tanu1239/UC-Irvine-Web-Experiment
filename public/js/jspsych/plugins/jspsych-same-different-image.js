...
jsPsych.plugins['same-different-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<images class="jspsych-same-different-stimulus" src="'+trial.stimuli[0]+'"></images>';
    ...
    function showSecondStim() {
      ...
      var html = '<images class="jspsych-same-different-stimulus" src="'+trial.stimuli[1]+'"></images>';
      //show prompt
