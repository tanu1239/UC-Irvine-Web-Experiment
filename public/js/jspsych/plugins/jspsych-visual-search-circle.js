...
jsPsych.plugins["visual-search-circle"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_fixation() {
      ...
      paper.innerHTML += "<images src='"+trial.fixation_image+"' style='position: absolute; top:"+fix_loc[0]+"px; left:"+fix_loc[1]+"px; width:"+trial.fixation_size[0]+"px; height:"+trial.fixation_size[1]+"px;'></images>";
    ...
    function show_search_array() {
      ...
      for (var i = 0; i < display_locs.length; i++) {
        ...
        paper.innerHTML += "<images src='"+to_present[i]+"' style='position: absolute; top:"+display_locs[i][0]+"px; left:"+display_locs[i][1]+"px; width:"+trial.target_size[0]+"px; height:"+trial.target_size[1]+"px;'></images>";
