...
jsPsych.plugins["custom-stop-signal-plugin"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var fix = '<images src="'+trial.fixation+'"id="jspsych-image-keyboard-response-stimulus"></images>';
    var new_html = '<images src="'+trial.stimulus1+'" id="jspsych-image-keyboard-response-stimulus"></images>';
    var new_html_2 = '<images src="'+trial.stimulus2+'" id="jspsych-image-keyboard-response-stimulus"></images>';
